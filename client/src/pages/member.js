    ...
    return(
        <div className="cont" style={{height:`315px`,width:`232px`}}>
            ...
            <div style={{display:`flex`, flexDirection:`column`, justifyContent:`center`, alignContent:`center`,textAlign:`center`}} >
                <p style={{color:`#FFFFFF`, fontSize:`28px`, fontFamily:`sans-serif`, margin:`18px 0 9px 0`}}><b>{props.name}</b> </p>
                <p style={{color:`#DDF140`, fontSize:`23px`, fontFamily:`sans-serif`}}>{props.pos}</p>
            </div>
        </div>
    );
}
